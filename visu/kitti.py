...
KITTI_LABELS = [
    ...
    Label("pedestrian", 48, -1, -1, 'human', 6, True, False, False, (220, 20, 60)),
    Label("railtrack", 49, -1, -1, 'object', 3, True, True, True, (153,153,153)),
    Label("smallPole", 50, -1, -1, 'object', 3, True, True, True, (153,153,153)),
    Label("trafficLight", 51, -1, -1, 'object', 3, True, True, True, (0,   64, 64)),
    Label("trafficSign", 52, -1, -1, 'object', 3, True, True, True, (0,  128,192)),
    Label("trashbin", 53, -1, -1, 'object', 3, True, True, True, (128, 64,  0)),
    Label("unknownConstruction", 54, -1, -1, 'void', 0, False, True, True, (102,  0,  0)),
    Label("unknownGround", 55, -1, -1, 'void', 0, False, True, True, ( 51,  0, 51)),
    Label("unknownObject", 56, -1, -1, 'void', 0, False, True, True, ( 32, 32, 32)),
    Label("unknownVehicle", 57, -1, -1, 'void', 0, False, True, True, (  0,  0,142)),
    Label("vendingmachine", 58, -1, -1, 'object', 3, True, True, True, (64,  64,128)),
]